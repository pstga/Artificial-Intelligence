...
class CustomResNet_Large(nn.Module):
    def __init__(self, num_classes):
        ...
        self.layer4 = ResidualBlock(in_channels=128, out_channels=128, stride=1)
    ...
    def forward(self, x):
        x = self.addcoords(x)  # addcoords adds 2 channels, 3+2=5
        ...
        x = self.layer2(x)
        x = self.pool_hw(x)  # Output is 256 channels
